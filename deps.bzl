...
def io_grpc_grpc_java(**kwargs):
    ...
    ref = get_ref(name, "b13d31c972fa5adf48a665659adc005c74d83024", kwargs)
    sha256 = get_sha256(name, "b20882d116453ddc82c6a0494f86ecf8a5a8735ae2e29827eb9640e3d272b363", kwargs)
